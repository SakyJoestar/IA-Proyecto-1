"""
    ...
    Archivo: HeuristicHeap.py
    Intención:
    Este archivo define la clase HeuristicHeap, la cual hereda de la clase Heap
    e implementa los métodos de comparación basados en la heurística de cada nodo.
"""
